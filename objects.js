function create_flower_1(x_pos, y_pos) {
    ...
    // javascript typically uses snakeCase rather than camel_case.
...
function create_dog_looking_through_fence() {
    ...
    // does d3 have something like `attrs`?
    // sleeve_left = dog.append("rect").attrs({
    //     x: 220 - 250
    //     y: h - 95
    //     ...
    // });
    //
    // Thinking about this further, I think what I'm getting at is that this
    // stuff is all static. I'd like to see it specified in a declarative
    // way:
    //
    // actors = [
    //     { type: "rect", x: ... },
    ...
    // ];
    //
    // Or, using react syntax:
    //
    // <g>
    //     <rect x={220-250} y={h-95} ... />
    //     <circle cx={...} ... />
    // </g>
    var sleeve_left = dog.append("rect")
        .attr("x", 220 - 250)
    ...
    // 250, 95, 15, 55 - I think these things deserve names
    var sleeve_left = dog.append("rect")
        .attr("x", 220 - 250)
        .attr("y", h - 95)
        .attr("width", 15)
